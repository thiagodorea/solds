...
public class SaleService {
    ...
    @Transactional(readOnly = true) //Garente que todas as requisições sejam feitas no service e o readOnly true impedi o look no banco para operações somente leitura
